...
<head>
    ...
    <title>Login Page - Practical</title>
          ...
          <div class="auth-wrapper auth-v2">
            <div class="auth-inner row m-0">
              <a class="brand-logo" href="javascript:void(0);">
                ...
                <h2 class="brand-text text-primary ml-1" style="margin-top: 5px;">Practical</h2></a>
              <!-- /Brand logo-->
              <!-- Left Text-->
              ...
              <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                  <h2 class="card-title font-weight-bold mb-1">Welcome Practical 👋</h2>
                  ...
                  <form class="auth-login-form mt-2" action="{{ route('register') }}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" id="login-email" type="text" name="name" value="{{ old('name') }}" autocomplete="off" placeholder="john" autofocus="" tabindex="1"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group input-group-merge form-password-toggle">
                        <input class="form-control form-control-merge" id="login-password" type="password" autocomplete="off" name="password_confirmation" placeholder="············" aria-describedby="login-password" tabindex="2"/>
                        <div class="input-group-append"><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span></div>
                      </div>
                    </div>
                    <div class="form-group">
