!(function (e, t, s) {
    ...
    i.each(function () {
        ...
        a.wrap('<div class="position-relative"></div>').select2({ dropdownAutoWidth: !0, width: "100%", maximumSelectionLength: 2, dropdownParent: a.parent(), placeholder: "Select maximum 2 items" }),
