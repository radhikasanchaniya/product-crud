$(function () {
    ...
    "laravel" === $("body").attr("data-framework") && (x = $("body").attr("data-asset-path")),
        ...
        S.length &&
            S.on("click", function () {
                Swal.fire({ title: "Click outside to close!", text: "This is a cool message!", allowOutsideClick: !0, customClass: { confirmButton: "btn btn-primary" }, buttonsStyling: !1 });
            }),
        y.length &&
            y.on("click", function () {
                Swal.mixin({
                    ...
                    .then(function (t) {
                        t.value && Swal.fire({ title: "All done!", html: "Your answers: <pre><code>" + JSON.stringify(t.value) + "</code></pre>", confirmButtonText: "Lovely!", customClass: { confirmButton: "btn btn-primary" } });
                    });
            }),
        C.length &&
            C.on("click", function () {
                Swal.fire({
                    ...
                    t.value && Swal.fire({ title: t.value.login + "'s avatar", imageUrl: t.value.avatar_url, customClass: { confirmButton: "btn btn-primary" } });
                });
            }),
        B.length &&
            B.on("click", function () {
